...
public class CRsTableIntCellRenderer extends DefaultTableCellRenderer
{
	public CRsTableIntCellRenderer()
	{
												   ...
												   boolean hasFocus, int row, int column)
	{
		...
		{
			System.out.println("Int: " + CRsTableModel.HIDDEN_INDEX + " - " + column);
			if (column == 0)
			{
