...
public class XmlMngr
{
     ...
     * <p>
     * <strong> Example: </strong> XmlMngr.getUserValueOf(new String[]
     * {"parser_pane","path"});
     * <p>
     * 
     * @param path
     *            Array of strings to following value<br/>
     ...
     * Returns null if element not found.
     * <p>
     * <strong> Example: </strong> XmlMngr.getSystemValueOf(new
     * String[] {"configs","tool_name"});
     * <p>
     * 
     * @param path
     *            Array of strings to following value<br/>
     ...
     * Returns null if element not found.
     * <p>
     * <strong> Example: </strong> XmlMngr.getMessageValueOf(new
     * String[] {"messages","error"});
     * <p>
     * 
     * @param path
     *            Array of {@link String} to following value<br/>
     * @return Return the value as a string <br/>
     */
     ...
     * <p>
     * <strong> Example: </strong> XmlMngr.getUserValueOf(new String[]
     * {"parser_pane","path"}, "Ops, fail!");
     * <p>
     * 
     * @param path
     *            Array of strings to following value<br/>
     * @param value
     *            Value to be set as element text<br/>
     ...
     * <p>
     * <strong> Example: </strong> XmlMngr.getSystemValueOf(new
     * String[] {"configs","tool_name"}, "Ops, fail!");
     * <p>
     * 
     * @param path
     *            Array of strings to following value<br/>
     ...
     * <p>
     * <strong> Example: </strong> XmlMngr.setMessageValueOf(new
     * String[] {"messages","error"}, "Ops, fail!");
     * <p>
     * 
     * @param path
     *            Array of strings to following value<br/>
